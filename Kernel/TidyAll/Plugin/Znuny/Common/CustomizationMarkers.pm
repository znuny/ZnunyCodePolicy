...
package TidyAll::Plugin::Znuny::Common::CustomizationMarkers;
...
Checks that only valid customization markers are used to mark changed lines in customized files.
