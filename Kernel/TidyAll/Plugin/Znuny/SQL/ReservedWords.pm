...
package TidyAll::Plugin::Znuny::SQL::ReservedWords;
...
EOF
            ...
            # All reserved words with small letters are from
            ...
            # 'reference' and 'login' seem to be allowed (checked by www.petefreitag.com)
            my @ReservedWords = (qw(
                add all alter and
                any as asc backup
            ...
            for my $ReservedWord (@ReservedWords) {
                if ( $1 && $1 =~ /^$ReservedWord$/i ) {
                    $Self->AddErrorMessage(<<"EOF");
Reserved SQL word '$ReservedWord' found in line $Counter: $Line
